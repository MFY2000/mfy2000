...
<body>
  ...
  <main id="main">
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>
                      <?php $dateOfBirth = date_create($data['dob']); echo $dateOfBirth->format('d M, Y');?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span><?=$data['mobile']?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <?=$data['Degree']?></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="<?=$data['Clients']?>"
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="<?=$data['Projects']?>"
                data-purecounter-duration="1" class="purecounter"></span>
              <p>Projects</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="<?=$data['Support']?>"
                data-purecounter-duration="1" class="purecounter"></span>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="<?=$data['Awards']?>" data-purecounter-duration="1"
          ...
          ?>
            <div class="progress col-lg-6">
              ...
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="<?=$data3['score']?>" aria-valuemin="0"
    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <?php
            $query4 = "SELECT `category` FROM resume GROUP BY `category`";
            $runquery4= mysqli_query($db,$query4);
            $i = 0;
            while($category = mysqli_fetch_array($runquery4)){  ?>


        <div class="row">
          <div class="col-lg-6">
            <h3 class="resume-title"><?= $category[$i] ?></h3>

            <?php
            $query5 = "SELECT * FROM resume WHERE `category` = '".$category[$i]."'"; 
            echo  $query5;
            $runquery5 = mysqli_query($db,$query5);
            while($data4 = mysqli_fetch_array($runquery5)){  ?>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <ul id="portfolio-flters">
              ...
              <?php
                $query4 = "SELECT `type` FROM `portfolio` GROUP by `type`";
                $runquery4= mysqli_query($db,$query4);
                $i = 0; $project = "";
                while($type = mysqli_fetch_array($runquery4)){ 
                  echo "<li data-filter='.filter-".$type[$i]."'>".$type[$i]."</li>";

                  $query5 = "SELECT * FROM `portfolio` WHERE `type` = '".$type[$i]."'"; 
                    ...
                    <div class='portfolio-wrap'>
                      ...
                      <div class='portfolio-info'>
                        ...
                        <div class='portfolio-links'>
                          <a href='./assets/img/".$data5['projectpic']."' data-gallery='portfolioGallery' class='portfolio-lightbox' title='".$data5['projectname']."'><i class='bx bx-plus'></i></a>
                          <a href='./details.php?id=".$data5['id']."' class='portfolio-details-lightbox' data-glightbox='type: external' title='Portfolio Details'><i class='bx bx-link'></i></a>
                        </div>
                      </div>
                    </div>
                  </div>";
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>MFY</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Developed by <a href="#"><?=$data['name']?></a>
      </div>
    </div>
  </footer><!-- End Footer -->
